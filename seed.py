...
test_rep = Representative(
    ...
    image="https://mn315.net/wp-content/uploads/2018/06/cropped-Ugandan-Knuckles.jpg",
    email="test@test.test",
    serving=True,
    district=district,
    websites=[{"url": "http://www.google.com"}, {"url": "http://tesla.com"}],
)
...
login_test = User.register(
    username="test",
    password="1234",
    first_name="test",
    last_name="test",
    email="test@test.com",
    address="82 Kent Blvd., Salamanca NY 14779",
)

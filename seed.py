...
test_rep = Representative(first_name='Testy', last_name='McTestface', full_name='Testy McTestface', house='lower', photo_url='https://mn315.net/wp-content/uploads/2018/06/cropped-Ugandan-Knuckles.jpg', email='test@test.test', serving=True)

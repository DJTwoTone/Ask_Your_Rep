...
test_rep = Representative(first_name='Testy', last_name='McTestface', full_name='Testy McTestface', photo_url='https://mn315.net/wp-content/uploads/2018/06/cropped-Ugandan-Knuckles.jpg', email='test@test.test', serving=True, district=district)
test_user = User.register(username='Someuser', password='1234567890', first_name='Some', last_name='User', email='some@user.com', address='123 Any St., Anytown NY 12345', home_district=district)
